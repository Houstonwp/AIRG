# Getting help with AIRG

Thanks for using AIRG. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/AIRG/issues) to make sure the 
